...
'''def create_pw_folder():
    ...
    folder_pw.protocol("WM_DELETE_WINDOW", on_closing(folder_pw))
...
def get_password():
    global new_pw_entry, confirm_pw_entry, folder_pw, root
    root = Tk()
    root.title("Private Folder")

    folder_pw = Tk()
    folder_pw.title("Encryption Password")
    ...
    folder_pw.protocol("WM_DELETE_WINDOW", on_closing)  # Call on_closing function when window is closed
...
def get_password():
    ...
    conditions_text = '''Password Conditions:
    ...
    conditions_display = tk.Label(root_password, text=conditions_text, justify="left")
    conditions_display.pack()
    root_password.protocol("WM_DELETE_WINDOW", on_closing(root_password))
...
Screen.protocol("WM_DELETE_WINDOW", on_closing(Screen))
